...
def help():
    ...
    print('\t-emailPasswordFile    : If you want email alerts of frames loss, state where your email password file is located.')
    print('\t                        The full path and filename')
    print('\t-sendAlert            : Defaults to false. Include this parameter if you want email notifications.')
    print('\t-recordStatsToFile    : To record statistics to a JSON file')
