...
class IxVmChassisBuilder(object):
    ...
    def ixVmDeleteVirtualChassis(self, vChassisIp):
        ...
        Parameter
           vChassisIp: The hypervisor's IP address. Mainly the virtual chassis IP.
        """
...
if mode == 'interactive':
    try:
        ...
        addOrRemoveCards = askQuestion('Do you want to add or remove IxVM cards/ports?\n\t(1=add, 2=remove, Default=1)',
        ...
        if addOrRemoveCards == '1':
            ...
            hypervisorInput = askQuestion('Which hypervisor:\n\n\t(1) vmware\n\t(2) qemu\n\nPlease select:',
                                          defaultValue=None, expectedPattern='1|2')
        ...
        # REMOVE
            ...
            removeVChassisInput = askQuestion('Do you want to remove the vChassis? (1=Yes, 2=No, Default=1) ',
                                              defaultValue='1', expectedPattern='1|2')
