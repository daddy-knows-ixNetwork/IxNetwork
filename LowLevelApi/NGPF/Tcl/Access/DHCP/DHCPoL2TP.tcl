...
puts "Create the DHCP Client stack in the chained Device Group on top of PPP client."
ixNet add $pppC dhcpv6client
ixNet commit

set dhcpC [ixNet getList $pppC dhcpv6client]

puts "Create the DHCP Server stack  on top of PPP server."
ixNet add $pppS dhcpv6server
ixNet commit

set dhcpS [ixNet getList $pppS dhcpv6server]
...
puts "Set the NCP Type of PPP Client and Server to IPv6"

ixNet setMultiAttribute [ixNet getA $pppC -ncpType]/singleValue -value ipv6
ixNet setMultiAttribute [ixNet getA $pppS -ncpType]/singleValue -value ipv6
ixNet commit

puts "Wait 5 sec"
after 5000

puts "Starting the Client and Server stacks."
ixNet exec start $dhcpS
after 5000
ixNet exec start $dhcpC
