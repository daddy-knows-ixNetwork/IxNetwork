...
set lacp1 [ixNet getList $mac1 staticLag]
set lacp2 [ixNet getList $mac2 staticLag]

puts "Renaming the topologies and the device groups"
ixNet setAttr $topo1  -name "LAG1-LHS"
ixNet setAttr $topo2  -name "LAG1-RHS"

ixNet setAttr $t1dev1 -name "SYSTEM1-StaticLag-LHS"
ixNet setAttr $t2dev1 -name "SYSTEM1-StaticLag-RHS"
ixNet commit
...
set sys1LagLHSport1lagId [ixNet getA $sys1LagLHSport1 -lagId]
set sys1LagLHSport2lagId [ixNet getA $sys1LagLHSport2 -lagId]
set sys1LagRHSport1lagId [ixNet getA $sys1LagRHSport1 -lagId]
set sys1LagRHSport2lagId [ixNet getA $sys1LagRHSport2 -lagId]

ixNet setMultiAttr $sys1LagLHSport1lagId -pattern singleValue -clearOverlays False
ixNet setMultiAttr $sys1LagLHSport2lagId -pattern singleValue -clearOverlays False
ixNet setMultiAttr $sys1LagRHSport1lagId -pattern singleValue -clearOverlays False
ixNet setMultiAttr $sys1LagRHSport2lagId -pattern singleValue -clearOverlays False
ixNet commit
...
after 5000
################################################################################
# 2. Start StaticLag protocol and wait for 60 seconds                          #
################################################################################
...
puts "\nFetching all StaticLag per-port statistics\n"
set viewPage {::ixNet::OBJ-/statistics/view:"Static LAG Per Port"/page}
set statcap [ixNet getAttr $viewPage -columnCaptions]
foreach statValList [ixNet getAttr $viewPage -rowValues] {
    foreach statVal $statValList  {
        puts "***************************************************"
...
ixNet exec linkUpDn $vportTx1 down
after 5000
################################################################################
...
set viewName "StaticLag-global-learned-Info-TCLview"
gererateLacpLearnedInfoView $viewName
ixNet exec refresh ::ixNet::OBJ-/statistics/view:"StaticLag-global-learned-Info-TCLview"
after 10000
puts "\nFetching all Global Learned Info\n"
set viewPage {::ixNet::OBJ-/statistics/view:"StaticLag-global-learned-Info-TCLview"/page}
set statcap [ixNet getAttr $viewPage -columnCaptions]
foreach statValList [ixNet getAttr $viewPage -rowValues] {
    foreach statVal $statValList  {
        puts "***************************************************"
...
ixNet exec linkUpDn $vportTx1 up
after 5000
################################################################################
# 8. Retrieve protocol statistics and StaticLag per port statistics            #
################################################################################
