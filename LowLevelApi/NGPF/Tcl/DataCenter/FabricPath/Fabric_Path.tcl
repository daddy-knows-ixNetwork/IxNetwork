...
#       simulated edge, it will add MAC pool which will serve as endpoints in  #
#       traffic.                                                               #
...
ixNet setAttr $topo1  -name "Topology 1 for Fabric Path"
ixNet setAttr $topo2  -name "Topology 2 for Fabric path"
...
puts "Adding Fabric Path interfaces"
ixNet add $mac1 isisFabricPath
ixNet add $mac2 isisFabricPath
ixNet commit

set fabricPathIf1 [ixNet getList $mac1 isisFabricPath]
set fabricPathIf2 [ixNet getList $mac2 isisFabricPath]

puts "Setting discard LSP off in Fabric Path Routers"
set fabricPathRouter1 [ixNet getList $t1dev1 isisFabricPathRouter]
set fabricPathRouter2 [ixNet getList $t2dev1 isisFabricPathRouter]
set mv1 [ixNet getAttribute $fabricPathRouter1 -discardLSPs]
set mv2 [ixNet getAttribute $fabricPathRouter2 -discardLSPs]
...
puts "Setting Mulitcast IPv4 group in Fabric Path Router 2"
ixNet setAttribute $fabricPathRouter2 -dceMCastIpv4GroupCount 1
ixNet commit

set dceMcastIpv4GroupList [ixNet getList $fabricPathRouter2 dceMCastIpv4GroupList]
set mvMcastAddrCount [ixNet getAttribute $dceMcastIpv4GroupList -mcastAddrCnt]
set mvStartMcastAddr [ixNet getAttribute $dceMcastIpv4GroupList -startMcastAddr]
...
puts "Setting Multicast MAC Groups in Fabric Path Router 2"
ixNet setAttribute $fabricPathRouter2 -dceMCastMacGroupCount 1
ixNet commit

set dceMCastMacGroupList [ixNet getList $fabricPathRouter2 dceMCastMacGroupList]

set mvMcastAddrCount [ixNet getAttribute $dceMCastMacGroupList -mcastAddrCnt]
set mvStartMcastAddr [ixNet getAttribute $dceMCastMacGroupList -startMcastAddr]
...
puts "Setting Mulitcast IPv6 group in Fabric Path Router 2"
ixNet setAttribute $fabricPathRouter2 -dceMCastIpv6GroupCount 1
ixNet commit

set dceMcastIpv6GroupList [ixNet getList $fabricPathRouter2 dceMCastIpv6GroupList]
set mvMcastAddrCount [ixNet getAttribute $dceMcastIpv6GroupList -mcastAddrCnt]
set mvStartMcastAddr [ixNet getAttribute $dceMcastIpv6GroupList -startMcastAddr]
...
puts "Adding Fabric Path Simulated Egde"
ixNet add $mac3 isisDceSimRouter
ixNet add $mac4 isisDceSimRouter
ixNet commit

puts "Adding MAC Pools behind Fabric Path Simulated Edge Device"
...
set viewPage {::ixNet::OBJ-/statistics/view:"Fabric-Path RTR Per Port"/page}
...
###############################################################################
puts "Fetching Fabric Path Learned Info"
ixNet exec getLearnedInfo $fabricPathIf1 1
after 5000
set linfo1 [ixNet getList $fabricPathIf1 learnedInfo]
