...
namespace eval ::ixia {
    ...
    set ixTclPort   8009
    set ports       {{10.216.116.120 2 1} { 10.216.116.120 2 2}}
}
...
puts "Adding mplsOAM over IP stacks"
...
set mplsOam1 [ixNet getList $ip1 mplsOam]
set mplsOam2 [ixNet getList $ip2 mplsOam]
...
puts "Changing reply mode to 2"
ixNet setMultiAttr [ixNet getAttr $mplsOam1 -replyMode]/singleValue -value replyviaipv4ipv6udppacket
ixNet setMultiAttr [ixNet getAttr $mplsOam2 -replyMode]/singleValue -value replyviaipv4ipv6udppacket
ixNet commit
...
ixNet setAttr $topo1  -name "MPLSOAM Topology 1"
ixNet setAttr $topo2  -name "MPLSOAM Topology 2"

ixNet setAttr $t1dev1 -name "LDP Topology 1 Router"
ixNet setAttr $t2dev1 -name "LDP Topology 2 Router"
ixNet commit

puts "Enabling LDP Router capabilities for mplsOam"
ixNet setMultiAttr [ixNet getAttr $ldp1 -enableBfdMplsLearnedLsp]/singleValue -value true
ixNet setMultiAttr [ixNet getAttr $ldp2 -enableBfdMplsLearnedLsp]/singleValue -value true
ixNet setMultiAttr [ixNet getAttr $ldp1 -enableLspPingLearnedLsp]/singleValue -value true
ixNet setMultiAttr [ixNet getAttr $ldp2 -enableLspPingLearnedLsp]/singleValue -value true
ixNet commit
...
puts "Enable reply to lsp ping on fec"
...
ixNet setMultiAttr [ixNet getAttr $ldpFEC1 -enableReplyingLspPing]/singleValue -value true
ixNet setMultiAttr [ixNet getAttr $ldpFEC2 -enableReplyingLspPing]/singleValue -value true
ixNet commit
...
################################################################################
# 2. Start MPLSOAM protocol and wait for 60 seconds
################################################################################
