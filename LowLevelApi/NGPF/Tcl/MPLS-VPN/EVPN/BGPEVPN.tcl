...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF BGP EVPN API.          #
#                                                                              #
...
ixNet setAttr $topo1  -name "EVPN Topology 1"
ixNet setAttr $topo2  -name "EVPN Topology 2"
...
puts "Adding EVPN EVI over BGP in both ports"
ixNet add $bgp1 bgpIPv4EvpnEvi
ixNet add $bgp2 bgpIPv4EvpnEvi
ixNet commit

set EvpnEvi1 [ixNet getList $bgp1 bgpIPv4EvpnEvi]
set EvpnEvi2 [ixNet getList $bgp2 bgpIPv4EvpnEvi]
...
ixNet setAttr [ixNet getAttr $ethernetSegment2 -esiValue]/singleValue -value "2"

puts "Adding Mac Pools behind EVPN  DG"
...
puts "Adding IPv4 addresses over MAC pools"
...
puts "Changing default values of MAC labels"
set cMAC1 [ixNet getList $macPool1 cMacProperties]
set cMAC2 [ixNet getList $macPool2 cMacProperties]
ixNet setAttr [ixNet getAttr $cMAC1 -firstLabelStart]/singleValue -value "1000"
ixNet setAttr [ixNet getAttr $cMAC2 -firstLabelStart]/singleValue -value "2000"

puts "Changing default values of IP prefixes"
set ipv4PrefixPool1 [ixNet getList $macPool1 ipv4PrefixPools]
set ipv4PrefixPool2 [ixNet getList $macPool2 ipv4PrefixPools]
ixNet setAttr [ixNet getAttr $ipv4PrefixPool1 -networkAddress]/singleValue -value "11.11.11.1"
ixNet setAttr [ixNet getAttr $ipv4PrefixPool2 -networkAddress]/singleValue -value "12.12.12.1"
ixNet commit
