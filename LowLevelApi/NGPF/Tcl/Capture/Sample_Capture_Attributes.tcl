...
ixNet setA $captureObj1 -controlSliceSize 64

puts "Set slice size for Data capture"
ixNet setA $captureObj2 -sliceSize 128
ixNet commit

puts "Setting Control Buffer"
ixNet setA $captureObj1 -controlBufferBehaviour bufferAfterStopCircular
ixNet setA $captureObj1 -controlBufferBehaviour bufferLiveNonCircular
ixNet setA $captureObj1 -controlBufferSize 33
ixNet commit

puts "Setting Data Buffer"
ixNet setA $captureObj2 -captureMode captureTriggerMode
ixNet commit
...
set filterPallette $captureObj2/filterPallette

ixNet setMultiAttrs $filterPallette                    \
...
ixNet setA $captureObj2/trigger -captureTriggerExpressionString SA1
ixNet commit

puts "Configure Data - Filter"
ixNet setA $captureObj2/trigger -captureFilterExpressionString SA1
ixNet commit

puts "Configure Control - Start Trigger"
ixNet setA $captureObj1 -controlCaptureFilter "arp and greater 1 and less 1024 and not (ether src 00:11:01:00:00:0a and ether dst ff:ff:ff:ff:ff:ff)"
ixNet commit

puts "Configure Control - Filter"
ixNet setA $captureObj1 -controlCaptureTrigger "arp and greater 1 and less 1024 and not (ether src 00:11:01:00:00:0a and ether dst ff:ff:ff:ff:ff:ff)"
ixNet commit
