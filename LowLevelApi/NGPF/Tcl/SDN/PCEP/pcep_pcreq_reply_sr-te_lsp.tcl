...
namespace eval ::ixia {
    set ports       {{10.216.108.96 2 1} {10.216.108.96 2 2}}
...
#    -destIpv4Address
################################################################################
set pceReqMatchCriteria1 $pccGroup1/pcRequestMatchCriteria:1
set sourceIpv4AddressMv [ixNet getAttribute $pceReqMatchCriteria1\
								-srcIpv4Address]
...
ixNet commit
set destinationIpv4AddressMv [ixNet getAttribute $pceReqMatchCriteria1\
								-destIpv4Address]
...
ixNet commit
set initialDelegation [ixNet getAttribute $reqLsp2 -initialDelegation]
...
################################################################################
set pcReplyLspParameters1 $pccGroup1/pcReplyLspParameters:1
set includeBandwidth [ixNet getAttribute $pcReplyLspParameters1 -includeBandwidth]
...
puts "Applying OTF for sending PCUpd message...."
...
puts "Checking statistics after PCUpdate"
################################################################################
# 7. Retrieve protocol statistics.  (PCE Sessions Per Port)                    #
################################################################################
puts "Fetching all PCE Sessions Per Port Stats\n"
