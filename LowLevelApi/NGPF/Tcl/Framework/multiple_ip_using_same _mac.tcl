...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use TCL APIs to generate        #
#    IPv4 Statistical routes.                                                  #
#    1. It will create 2 IPv4 topologies.                                      #
#    2. Set multiple ipv4 instances over single mac                            #
...
namespace eval ::ixia {
    set ixTclServer 10.39.35.71
    set ixTclPort   8009
    set ports       {{10.39.33.243 3 1} { 10.39.33.243 3 2}}
}
...
ixNet connect $::ixia::ixTclServer -port $::ixia::ixTclPort \
    –setAttribute strict
...
################################################################################
# Setting Multiple IPv4 instances over single Mac                              #
################################################################################

ixNet setAttr $ip1 -multiplier 10
ixNet setAttr $ip2 -multiplier 10
ixNet commit
