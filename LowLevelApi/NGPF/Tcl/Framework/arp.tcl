...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use arp functionality           #
#    it will configure 2 topologyes with IPv4 and than it will send arp        #
...
puts "Send Arp from IP1 Item 1"
puts [ixNet exec sendArp [lindex $ip1Items 0]]
after 1000

puts "Send Arp from all IP1 items"
puts [ixNet exec sendArp $ip1]

puts "Send Arp from IP1/Item 1 to IP2/Item 1 IP address"
puts [ixNet exec sendArpManual [lindex $ip1Items 0] $ip2Item1_IP]

puts "Send Arp from IP1/Item 1 to a non-existing IP address"
puts [ixNet exec sendArpManual [lindex $ip1Items 0] 22.1.2.3]
...
puts " "
puts "ixNet exec sendArp"
puts " "
puts "ixNet exec sendArpManual"
