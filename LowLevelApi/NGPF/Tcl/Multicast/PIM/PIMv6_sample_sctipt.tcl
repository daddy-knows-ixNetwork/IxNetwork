...
#                                                                              #
#    Revision Log:                                                             #
#    12/17/2014 - Rupam Paul   - created sample                                #
#                                                                              #
################################################################################
...
ixNet setAttr $mvAdd2/singleValue -value "2000::2"
ixNet setAttr $mvGw1/singleValue  -value "2000::2"
...
puts "Adding PIM over IP6 stacks"
ixNet add $ip1 pimV6Interface
ixNet add $ip2 pimV6Interface
ixNet commit

set pim1 [ixNet getList $ip1 pimV6Interface]
set pim2 [ixNet getList $ip2 pimV6Interface]
...
puts "Modifying the Hello Hold time in the first PIM router"
set helloHoldTimeMultiValue1 [ixNet getAttr $pim1 -helloHoldTime]
ixNet setAttr $helloHoldTimeMultiValue1 -pattern singleValue -clearOverlays False
ixNet setAttr $helloHoldTimeMultiValue1/singleValue -value 110
...
puts "Modifying the Hello Hold time in the second PIM router"
set helloHoldTimeMultiValue2 [ixNet getAttr $pim2 -helloHoldTime]
ixNet setAttr $helloHoldTimeMultiValue2 -pattern singleValue -clearOverlays False
ixNet setAttr $helloHoldTimeMultiValue2/singleValue -value 110
...
set pimV6JoinPruneList1 [ixNet getList $pim1 pimV6JoinPruneList]
set pimV6JoinPruneList2 [ixNet getList $pim2 pimV6JoinPruneList]

puts "Modifying the RP Address in the first PIM router"
set rpMultiValue1 [ixNet getAttr $pimV6JoinPruneList1 -rpV6Address]
ixNet setAttr $rpMultiValue1 -pattern singleValue -clearOverlays False
ixNet setAttr $rpMultiValue1/singleValue -value "3000::1"

puts "Modifying the RP Address in the Second PIM router"
set rpMultiValue2 [ixNet getAttr $pimV6JoinPruneList2 -rpV6Address]
ixNet setAttr $rpMultiValue2 -pattern singleValue -clearOverlays False
ixNet setAttr $rpMultiValue2/singleValue -value "3000::1"

puts "Modifying the Rangetype from *G to SG in the first PIM router"
set rangeTypeMultiValue1 [ixNet getAttr $pimV6JoinPruneList1 -rangeType]
...
set rangeTypeMultiValue2 [ixNet getAttr $pimV6JoinPruneList2 -rangeType]
...
set groupaddressMultiValue1 [ixNet getAttr $pimV6JoinPruneList1 -groupV6Address]
ixNet setAttr $groupaddressMultiValue1 -pattern singleValue -clearOverlays False
ixNet setAttr $groupaddressMultiValue1/singleValue -value "ff15::1"

puts "Modifying the Group Address in the Second PIM router"
set groupaddressMultiValue2 [ixNet getAttr $pimV6JoinPruneList2 -groupV6Address]
ixNet setAttr $groupaddressMultiValue2 -pattern singleValue -clearOverlays False
ixNet setAttr $groupaddressMultiValue2/singleValue -value "ff16::1"

set pimV6SourcesList1 [ixNet getList $pim1 pimV6SourcesList]
set pimV6SourcesList2 [ixNet getList $pim2 pimV6SourcesList]

puts "Modifying the TX Iteration Gap in the first PIM router"
set txgapMultiValue1 [ixNet getAttr $pimV6SourcesList1 -txIterationGap]
...
set txgapMultiValue2 [ixNet getAttr $pimV6SourcesList2 -txIterationGap]
...
set pimV6CandidateRPsList1 [ixNet getList $pim1 pimV6CandidateRPsList]
set pimV6CandidateRPsList2 [ixNet getList $pim2 pimV6CandidateRPsList]

puts "Modifying Priority in the first PIM router"
set priorityMultiValue1 [ixNet getAttr $pimV6CandidateRPsList1 -priority]
...
set priorityMultiValue2 [ixNet getAttr $pimV6CandidateRPsList2 -priority]
...
puts "Disabling the Enable pack checkbox for the first pim router"
set enableMultiValue1 [ixNet getAttr $pimV6JoinPruneList1 -enablePack]
ixNet setAttr $enableMultiValue1 -pattern singleValue -clearOverlays False
ixNet setAttr $enableMultiValue1/singleValue -value False

puts "Disabling the Enable pack checkbox for the second pim router"
set enableMultiValue2 [ixNet getAttr $pimV6JoinPruneList2 -enablePack]
ixNet setAttr $enableMultiValue2 -pattern singleValue -clearOverlays False
ixNet setAttr $enableMultiValue2/singleValue -value False
...
puts "ixNet help ::ixNet::OBJ-/topology/deviceGroup/ethernet/ipv6/pimV6Interface"

puts "Adding Ipv6 prefixpool behind PIM DG"
...
set ipv6prefixpool1 [ixNet add $networkGroup1 ipv6PrefixPools]
set ipv6prefixpool2 [ixNet add $networkGroup2 ipv6PrefixPools]
ixNet commit
...
ixNet setMultiAttribute $connector1\
    -connectedTo $networkGroup1/ipv6PrefixPools:1
ixNet commit
...
ixNet setMultiAttribute $connector2\
    -connectedTo $networkGroup2/ipv6PrefixPools:1
ixNet commit
