...
namespace eval ::ixia {
    ...
    set ixTclPort   8071
    set ports       {{10.205.28.63 9 1} { 10.205.28.63 9 2}}
}
...
puts "Adding NetworkGroup behind OSPFv2 DG"
...
ixNet setAttr $networkGroup2 -name "OSPF_2_Network_Group1"
ixNet commit
...
set ospfPseudoRouter1 [lindex [ixNet getList $simRouter1 ospfPseudoRouter] 0]
...
set ospfPseudoRouter2 [lindex [ixNet getList $simRouter2 ospfPseudoRouter] 0]
set extRoute2         [lindex [ixNet getList $ospfPseudoRouter2 ospfPseudoRouterType1ExtRoutes] 0]
set activeMultivalue2 [ixNet getAttr $extRoute2 -active]
...
set destination  [list $networkGroup2/networkTopology/simRouter:1/ospfPseudoRouter:1/ospfPseudoRouterType1ExtRoutes:1]
