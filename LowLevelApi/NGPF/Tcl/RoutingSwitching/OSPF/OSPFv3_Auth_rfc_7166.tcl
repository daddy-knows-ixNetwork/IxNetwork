...
namespace eval ::ixia {
    set ixTclServer 10.117.157.255
    set ixTclPort   8009
    set ports       {{10.39.37.58 2 11} {10.39.37.58 2 12}}
}
...
puts "Enabling ospfv3 Authentication"
set enableAuth1 [ixNet getAttr $ospf1 -enableAuthentication]
set enableAuth2 [ixNet getAttr $ospf2 -enableAuthentication]
ixNet setAttr $enableAuth1/singleValue -value "True"
ixNet setAttr $enableAuth2/singleValue -value "True"
ixNet commit
after 2000

puts "Changing the Authentication Parameter"

puts "Chainging Auth Algo to HMAC-SHA-256 on DG1!!!\n"
set authAlgo1 [ixNet getAttr $ospf1 -authAlgo]
ixNet setAttr $authAlgo1/singleValue -value "sha256"
puts "Chainging SA ID to 10 on DG1!!!\n"
set saId1 [ixNet getAttr $ospf1 -saId]
ixNet setAttr $saId1/singleValue -value 10
puts "Chainging Auth Data DG1!!!\n"
set key1 [ixNet getAttr $ospf1 -key]
ixNet setAttr $key1/singleValue -value "key1234"

puts "Chainging Auth Algo to HMAC-SHA-256 on DG2!!!\n"
set authAlgo2 [ixNet getAttr $ospf2 -authAlgo]
ixNet setAttr $authAlgo2/singleValue -value "sha256"
puts "Chainging Auth Data DG2!!!\n"
set key2 [ixNet getAttr $ospf2 -key]
ixNet setAttr $key2/singleValue -value "key1234"
ixNet commit
after 2000
