...
puts "Configure DUT SCI in Rx Properties of MACsec 1"
set dutSciMacMv [ixNet getAttribute $macsec1 -dutSciMac]
...
################################################################################
# Set CipherSiute AES-XPN-128 for all devices in MACsec 1
################################################################################
puts "Set CipherSiute AES-XPN-128 for all devices in MACsec 1"
set cipherSuite1 [ixNet getAttribute $macsec1 -cipherSuite]
...
################################################################################
puts "Set Tx SAK Pool size and Rx SAK Pool size as 4 for all devices in MACsec 1"
...
################################################################################
puts "Configure Tx SAK and Rx SAK for all devices in MACSec 1"
set txSakPool1 [ixNet getList $macsec1 txSakPool]
set txSak128mv1 [ixNet getAttribute $txSakPool1 -txSak128]
ixNet setMultiAttribute $txSak128mv1/counter -direction "increment" -start "f123456789abcdef0123456789a11111" -step "00000000000000000000000000000001"
ixNet commit
set rxSakPool1 [ixNet getList $macsec1 rxSakPool]
set rxSak128mv1 [ixNet getAttribute $rxSakPool1 -rxSak128]
ixNet setMultiAttribute $rxSak128mv1/counter -direction "increment" -start "f123456789abcdef0123456789a11111" -step "00000000000000000000000000000001"
ixNet commit
...
puts "Configure DUT SCI in Rx Properties of MACsec 2"
set dutSciMacMv [ixNet getAttribute $macsec2 -dutSciMac]
ixNet add $dutSciMacMv "counter"
ixNet setMultiAttribute $dutSciMacMv/counter\
             -direction "increment"\
             -start     "00:11:01:00:00:01"\
...
################################################################################
# Set CipherSiute AES-XPN-128 for all devices in MACsec 2
################################################################################
puts "Set CipherSiute AES-XPN-128 for all devices in MACsec 2"
set cipherSuite2 [ixNet getAttribute $macsec2 -cipherSuite]
...
################################################################################
puts "Set Tx SAK Pool size and Rx SAK Pool size as 4 for all devices in MACsec 2"
...
################################################################################
puts "Configure Tx SAK and Rx SAK for all devices in MACSec 2"
set txSakPool2 [ixNet getList $macsec2 txSakPool]
set txSak128mv2 [ixNet getAttribute $txSakPool2 -txSak128]
ixNet setMultiAttribute $txSak128mv2/counter -direction "increment" -start "f123456789abcdef0123456789a11111" -step "00000000000000000000000000000001"
ixNet commit
set rxSakPool2 [ixNet getList $macsec2 rxSakPool]
set rxSak128mv2 [ixNet getAttribute $rxSakPool2 -rxSak128]
ixNet setMultiAttribute $rxSak128mv2/counter -direction "increment" -start "f123456789abcdef0123456789a11111" -step "00000000000000000000000000000001"
ixNet commit
################################################################################
