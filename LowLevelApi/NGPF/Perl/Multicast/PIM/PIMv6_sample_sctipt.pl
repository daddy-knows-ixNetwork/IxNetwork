...
$ixNet->setAttribute($mvAdd1.'/singleValue', '-value', '2000::2');
$ixNet->setAttribute($mvAdd2.'/singleValue', '-value', '2000::1');
$ixNet->setAttribute($mvGw1.'/singleValue', '-value', '2000::1');
$ixNet->setAttribute($mvGw2.'/singleValue', '-value', '2000::2');
...
my $pim1 = ($ixNet->getList($ip1, 'pimV6Interface'))[0];
my $pim2 = ($ixNet->getList($ip2, 'pimV6Interface'))[0];
...
my $pimV6JoinPruneList1 = ($ixNet->getList($pim1, 'pimV6JoinPruneList'))[0];
my $pimV6JoinPruneList2 = ($ixNet->getList($pim2, 'pimV6JoinPruneList'))[0];

print ("Modifying the RP Address in the first PIM router\n");
my $rpMultiValue1 = $ixNet->getAttribute($pimV6JoinPruneList1, '-rpV6Address');
...
my $rpMultiValue2 = $ixNet->getAttribute($pimV6JoinPruneList2, '-rpV6Address');
...
my $rangeTypeMultiValue1 = $ixNet->getAttribute($pimV6JoinPruneList1, '-rangeType');
...
my $rangeTypeMultiValue2 = $ixNet->getAttribute($pimV6JoinPruneList2, '-rangeType');
...
my $groupaddressMultiValue1 = $ixNet->getAttribute($pimV6JoinPruneList1, '-groupV6Address');
...
my $groupaddressMultiValue2 = $ixNet->getAttribute($pimV6JoinPruneList2, '-groupV6Address');
...
my $pimV6SourcesList1 = ($ixNet->getList($pim1, 'pimV6SourcesList'))[0];
my $pimV6SourcesList2 = ($ixNet->getList($pim2, 'pimV6SourcesList'))[0];

print ("Modifying the TX Iteration Gap in the first PIM router\n");
my $txgapMultiValue1 = $ixNet->getAttribute($pimV6SourcesList1, '-txIterationGap');
...
my $txgapMultiValue2 = $ixNet->getAttribute($pimV6SourcesList2, '-txIterationGap');
...
my $pimV6CandidateRPsList1 = ($ixNet->getList($pim1, 'pimV6CandidateRPsList'))[0];
my $pimV6CandidateRPsList2 = ($ixNet->getList($pim2, 'pimV6CandidateRPsList'))[0];

print ("Modifying Priority in the first PIM router\n");
my $priorityMultiValue1 = $ixNet->getAttribute($pimV6CandidateRPsList1, '-priority');
...
my $priorityMultiValue2 = $ixNet->getAttribute($pimV6CandidateRPsList2, '-priority');
...
my $ipv6prefixpool1 = $ixNet->add($networkGroup1, 'ipv6PrefixPools');
my $ipv6prefixpool2 = $ixNet->add($networkGroup2, 'ipv6PrefixPools');
$ixNet->commit();
...
$ixNet->setMultiAttribute($connector2, '-connectedTo',
    $networkGroup2.'/ipv6PrefixPools:1');
$ixNet->commit();
...
# 4. Retrieve protocol learned info
###############################################################################
print("Fetching PIMv6 Basic Learned Info\n");
