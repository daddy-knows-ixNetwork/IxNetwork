...
my $ixTclServer = '10.205.28.84';
my $ixTclPort   = '8071';
my @ports       = (('10.205.28.63', '9', '1'), ('10.205.28.63', '9', '2'));
...
my $ospfPseudoRouter2  = ($ixNet->getList($simRouter2, 'ospfPseudoRouter'))[0];
my $extRoute2          = ($ixNet->getList($ospfPseudoRouter2, 'ospfPseudoRouterType1ExtRoutes'))[0];
my $activeMultivalue2  = $ixNet->getAttribute($extRoute2, '-active');
...
my @destination  = ($networkGroup2.'/networkTopology/simRouter:1/ospfPseudoRouter:1/ospfPseudoRouterType1ExtRoutes:1');
