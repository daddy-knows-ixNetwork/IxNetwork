...
my $ixTclPort   = '8239';
my @ports       = (('10.39.50.123', '5', '15'), ('10.39.50.123', '5', '16'));
...
my $cap1 = $ixNet->getAttribute($bgp1, '-capabilitySRTEPoliciesV6');
my $cap2 = $ixNet->getAttribute($bgp2, '-capabilitySRTEPoliciesV6');
...
print("Enabling IPv6 SRTE Learn Info Filter \n");
my $filter1 = $ixNet->getAttribute($bgp1, '-filterSRTEPoliciesV6');
my $filter2 = $ixNet->getAttribute($bgp2, '-filterSRTEPoliciesV6');
...
my $ip6pool = ($ixNet->getList($networkGroup1, 'ipv6PrefixPools'))[0];
my $bgpV6IPRouteProperty = ($ixNet->getList($ip6pool, 'bgpV6IPRouteProperty'))[0];
