...
$ixNet->setMultiAttribute($sourceIpv4AddressMv.'/counter',
             ...
             '-step'     , '0.0.0.1');
$ixNet->commit();
my $initialDelegation = $ixNet->getAttribute($reqLsp2, '-initialDelegation');
$ixNet->add($initialDelegation, 'singleValue');
$ixNet->setMultiAttribute($initialDelegation.'/singleValue',
            '-value', 'true');
$ixNet->commit();
my $includeMetricMv = $ixNet->getAttribute($reqLsp2, '-includeMetric');
...
#    -active
################################################################################
my $reqLspMetric2 = $reqLsp2.'/pcepIroSubObjectsList:1';
my $subObjectTypeMv = $ixNet->getAttribute($reqLspMetric2, '-subObjectType');
...
$ixNet->setMultiAttribute($ipv4AddressMv.'/counter',
             ...
             '-step'     , '0.0.0.1');
$ixNet->commit();
my $prefixLengthMv = $ixNet->getAttribute($reqLspMetric2, '-prefixLength');
$ixNet->add($prefixLengthMv, 'singleValue');
$ixNet->setMultiAttribute($prefixLengthMv.'/singleValue',
            '-value', '24');
$ixNet->commit();
my $activeMv = $ixNet->getAttribute($reqLspMetric2, '-active');
