...
#                                                                              #
#    Revision Log:                                                             #
#    03/12/2015 - Poulomi Chatterjee- created sample                           #
#                                                                              #
################################################################################
...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF BGP EVPN PERL API.     #
#                                                                              #
...
my $EvpnEvi1 = ($ixNet->getList($bgp1, 'bgpIPv4EvpnEvi'))[0];
my $EvpnEvi2 = ($ixNet->getList($bgp2, 'bgpIPv4EvpnEvi'))[0];
...
my $cMAC1 = ($ixNet->getList($macPool1, 'cMacProperties'))[0];
my $cMAC2 = ($ixNet->getList($macPool2, 'cMacProperties'))[0];
...
my $ipv4PrefixPool1 = ($ixNet->getList($macPool1, 'ipv4PrefixPools'))[0];
my $ipv4PrefixPool2 = ($ixNet->getList($macPool2, 'ipv4PrefixPools'))[0];
