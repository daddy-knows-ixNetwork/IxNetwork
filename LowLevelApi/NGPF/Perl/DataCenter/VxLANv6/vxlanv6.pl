...
$ixNet->add($mac1_1, 'ipv6');
$ixNet->add($mac2_1, 'ipv6');
$ixNet->commit();
my @ipv61 = $ixNet->getList($mac1_1, 'ipv6');
my @ipv62 = $ixNet->getList($mac2_1, 'ipv6');
my $ipv61_1 = @ipv61[0];
my $ipv62_1 = @ipv62[0];
print "Setting multi values for ipv6 addresses\n";
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv61_1, '-address').'/counter', '-start', '2000:0:0:1:0:0:0:2', '-step', '0:0:0:1:0:0:0:0');
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv61_1, '-gatewayIp').'/counter', '-start', '2000:0:0:1:0:0:0:1', '-step', '0:0:0:1:0:0:0:0');
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv61_1, '-resolveGateway').'/singleValue', '-value', 'true');
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv62_1, '-address').'/counter', '-start', '2000:0:0:1:0:0:0:1', '-step', '0:0:0:1:0:0:0:0');
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv62_1, '-gatewayIp').'/counter', '-start', '2000:0:0:1:0:0:0:2', '-step', '0:0:0:1:0:0:0:0');
$ixNet->setMultiAttribute($ixNet->getAttribute($ipv62_1, '-resolveGateway').'/singleValue', '-value', 'true');
$ixNet->commit();

print "Add VXLANv6 stacks to IPv6\n";
$ixNet->add($ipv61_1, 'vxlanv6');
$ixNet->add($ipv62_1, 'vxlanv6');
$ixNet->commit();

my @vxlanv61 = $ixNet->getList($ipv61_1, 'vxlanv6');
my @vxlanv62 = $ixNet->getList($ipv62_1, 'vxlanv6');

my $vxlanv6_1 = @vxlanv61[0];
my $vxlanv6_2 = @vxlanv62[0];
...
print "Add Ethernet stacks to IPv4 hosts\n";
...
print "Add IPv4 stacks to IPv4 hosts\n";
...
print("***************************************************\n");
print("VXLANv6  per port Stats\n");
my $viewPage = '::ixNet::OBJ-/statistics/view:"VXLANv6 Per Port"/page';
my @statcap  = $ixNet->getAttribute($viewPage, '-columnCaptions');
my @rowvals  = $ixNet->getAttribute($viewPage, '-rowValues');
my $index    = 0;
my $statValueList= '';
...
###############################################################################
print("Fetching VxLANv6 Learned Info\n");
$ixNet->execute('getVXLANLearnedInfo', $vxlanv6_1, 1);
sleep(5);
my $linfo1 = ($ixNet->getList($vxlanv6_1, 'learnedInfo'))[0];
