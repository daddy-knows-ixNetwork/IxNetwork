...
################################################################################
print("Set CipherSuite AES-XPN-128 for all devices in MACsec 1\n");
my $cipherSuite1 = $ixNet->getAttribute($macsec1, '-cipherSuite');
...
$ixNet->commit();
################################################################################
# Add Device Group in Topology 2
################################################################################
...
################################################################################
print("Add Macsec on top of Ethernet in Device Group 2\n");
...
my $cipherSuite2 = $ixNet->getAttribute($macsec2, '-cipherSuite');
...
print("Configure IPv4 addresses and Gateway \n");
