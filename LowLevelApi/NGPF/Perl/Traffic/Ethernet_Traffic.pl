...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF Ethernet Traffic  API  #
#    It will create the Ethernet and then will create the traffic using        #
#    Ethernet end point and than retrieve and display few statistics           #
#                                                                              #
################################################################################
...
my @source       = ($topo2.'/deviceGroup:1/ethernet:1');
my @destination  = ($topo1.'/deviceGroup:1/ethernet:1');
...
$ixNet->setMultiAttribute($trafficItem1.'/tracking',
    '-trackBy',        ['trackingenabled0','sourceDestValuePair0'],
