...
# below
#################################################################################
ixTclServer = '10.66.46.92'
ixTclPort   = '5445'
ports       = [('10.39.50.223', '2', '33',), ('10.39.50.223', '2', '37',), ('10.39.50.223', '2', '34',), ('10.39.50.223', '2', '38',)]
...
####################### MicroBFDv4 Configuration #########################
#MicroBFDv4 Configuring on Ethernet Port 1 and Ethernet Port 2
#MicroBFDv4 Source IPv4 Address and Destination IPv4 Address Configured.
##########################################################################
ixNet.add(lag1eth, 'microbfdv4')
ixNet.commit()
ixNet.add(lag2eth, 'microbfdv4')
ixNet.commit()

lag1microv4 = ixNet.getList(lag1eth,'microbfdv4')[0]
lag2microv4 = ixNet.getList(lag2eth,'microbfdv4')[0]


Microbfdv4sourceIPAdd1 = ixNet.getAttribute(lag1microv4, '-sourceIP4Address')
ixNet.setMultiAttribute(Microbfdv4sourceIPAdd1 + '/singleValue', '-value', '1.1.1.1')
ixNet.commit()
Microbfdv4DestIPAdd1 = ixNet.getAttribute(lag1microv4,'-destinationIP4Address')
ixNet.setMultiAttribute(Microbfdv4DestIPAdd1 + '/singleValue', '-value', '2.2.2.2')
ixNet.commit()

time.sleep(3)

Microbfdv4sourceIPAdd2 = ixNet.getAttribute(lag2microv4,'-sourceIP4Address')
ixNet.setMultiAttribute(Microbfdv4sourceIPAdd2 + '/singleValue', '-value', '2.2.2.2')
ixNet.commit()
Microbfdv4DestIPAdd2 = ixNet.getAttribute(lag2microv4,'-destinationIP4Address')
ixNet.setMultiAttribute(Microbfdv4DestIPAdd2 + '/singleValue', '-value', '1.1.1.1')
ixNet.commit()
#########################################################################################
##################################################################################
