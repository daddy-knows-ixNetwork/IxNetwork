...
puts "Sleep 30sec to send traffic"
sleep(60)
...
for stack in stacklist.each do
    if stack.include?('Frame') then
        allFields = @ixNet.getList(stack, 'field')
    end
end
for field in allFields.each do
