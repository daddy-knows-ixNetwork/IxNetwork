...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to export a view		           #
# Module:                                                                      #
...
# For Grid View use one of the following file types: HTML, XML, TXT, XLS
...
# For Chart or Gauge View use one of the following file types: BMP, WMF, EMF, GIF, JPEG, PNG, TIFF
