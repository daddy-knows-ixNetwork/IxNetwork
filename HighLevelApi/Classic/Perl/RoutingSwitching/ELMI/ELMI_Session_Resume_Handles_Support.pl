...
my $test_name              = "ELMI_Protocol_Session_Resume_Evc_Handles";
...
my @evc_handles_1               = ixiahlt::status_item("$port_1.emulation_elmi_config.evc_handles");
my @uni_status_handles_1        = ixiahlt::status_item("$port_1.emulation_elmi_config.uni_status_handles");
my @bw_profile_handles_1        = ixiahlt::status_item("$port_1.emulation_elmi_config.bw_profile_handles");
my @ce_vlan_id_range_handles_1  = ixiahlt::status_item("$port_1.emulation_elmi_config.ce_vlan_id_range_handles");

my $format = "%-40s %-s %-10s\n";
printf $format, "uni_handle_0", "=", $uni_handle_0;
printf $format, "uni_handle_1", "=", $uni_handle_1;
printf $format, "evc_handles", "=", @evc_handles_1;
printf $format, "uni_status_handles", "=", @uni_status_handles_1;
printf $format, "bw_profile_handles", "=", @bw_profile_handles_1;
printf $format, "ce_vlan_id_range_handles", "=", @ce_vlan_id_range_handles_1;
