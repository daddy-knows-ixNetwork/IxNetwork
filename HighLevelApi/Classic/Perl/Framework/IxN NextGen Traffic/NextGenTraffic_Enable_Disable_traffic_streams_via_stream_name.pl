...
#
#    Revision Log:
#    05-16-2013 LBose - Initial Version
#
################################################################################
...
#                                                                              #
# Description:                                                                 #
#    This sample script configures two traffic items on a port.                #
# The traffic streams are enabled and/or disbled using the stream name.        #
# Module:                                                                      #
...
my $test_name              = "Activate_deactivate_traffic_streams_via_stream_name";
...
################################################################################
# Disable Traffic Item -1  using the  stream names                             #
################################################################################
$_result_ = ixiahlt::traffic_config ({
    mode                  => 'disable',
...
################################################################################
# Disable Traffic Item - 2 using the  stream names                             #
################################################################################
$_result_ = ixiahlt::traffic_config ({
    mode                  => 'disable',
    stream_id             => $traffic_item2,
});
&catch_error();
