...
#                                                                              #
# Description:                                                                 #
#    This sample script loads an IxNetwork configuration for a traffic         #
# item and retrieves the traffic headers using session_info.                   #
#                                                                              #
# Module:                                                                      #
...
@ti_nameList = ixiahlt::status_item('traffic_config');

my $ti_name1 = $ti_nameList[0];
my $ti_name2 = $ti_nameList[1];

################################################################################
# Retrieve the Traffic CE for the given traffic item                           #
...
my $ce1 = ixiahlt::status_item("$ti_name1.traffic_config.traffic_item");
my $ce2 = ixiahlt::status_item("$ti_name2.traffic_config.traffic_item");

################################################################################
# Retrieve the Traffic HLS for the given traffic item                          #
# using the session_info                                                       #
################################################################################
$_result_ = ixiahlt::session_info ( {
    mode        =>   'get_traffic_hls',
});
&catch_error();

my $hls1 = ixiahlt::status_item("$ti_name1.traffic_config.${ce1}.stream_ids");
my $hls2 = ixiahlt::status_item("$ti_name2.traffic_config.${ce2}.stream_ids");


################################################################################
# Retrieve the Traffic Headers for the given traffic CE                        #
# using the session_info                                                       #
################################################################################
$_result_ = ixiahlt::session_info ( {
   mode             =>   'get_traffic_headers',
   traffic_handle   =>   $ce1,
});
&catch_error();
