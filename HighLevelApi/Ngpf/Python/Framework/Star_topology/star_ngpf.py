...
#   retrievals.                                                                #
#                                                                              #
#   Furthermore, script configures a scenario with 2 topologies:               #
#        - Topology 1 with Ethernet and IPv4 stacks							   #
#        - Topology 2 with Ethernet and IPv4 stacks 						   #
#   Afterwards, the script:										               #
#    	 - starts/stops the protocols									       #
#		 - collects and displays IPv4 and Ethernet statistics 				   #
#																			   #
#                                                                              #
# Module:                                                                      #
...
chassis_ip = ['master_chassis', 'slave_1', 'slave_2', 'slave_3']
tcl_server = "localhost"
ixnetwork_tcl_server = 'localhost'
port_list = [['4/1'], [], ['4/1'],[]]
master_chassis = ['none', 'master_chassis','master_chassis','master_chassis']
chain_cables_length = [0,3,6,6]
chain_type = 'star'
cfgErrors = 0
...
check_chain_type = connect_result['connection']['chassis'][chassis_ip[0]]['chain_type']
check_slave1 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[1]+'.is_master_chassis')
check_slave2 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[2]+'.is_master_chassis')
check_slave3 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[3]+'.is_master_chassis')

check_master_of_slave1 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[1]+'.chassis_chain.master_device')
check_master_of_slave2 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[2]+'.chassis_chain.master_device')
check_master_of_slave3 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[3]+'.chassis_chain.master_device')

check_cable_length1 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[1]+'.chassis_chain.cable_length')
check_cable_length2 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[2]+'.chassis_chain.cable_length')
check_cable_length3 = ixiatcl.keylget(connect_result,'connection.chassis.'+chassis_ip[3]+'.chassis_chain.cable_length')
