...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF BGP EVPN HLPy API.     #
#                                                                              #
...
bgpIPv4EvpnEvi_1_handle = _result_['evpn_evi']
...
bgpIPv4EvpnEvi_2_handle = _result_['evpn_evi']
...
_result_ = ixiangpf.network_group_config(
      ...
      multiplier                            = "1",
      enable_device                         = "1",
      connected_to_handle                   = bgpIPv4EvpnEvi_2_handle,
      type                                  = "mac-ipv4-prefix",
      mac_pools_multiplier                  = "1",
      mac_pools_prefix_length               = "48",
...
_result_ = ixiangpf.emulation_bgp_route_config(
      ...
      advertise_ipv4_address                          = "1",
      active_ts                                       = "1",
      first_label_start                               = "416",
      enable_second_label                             = "1",
      second_label_start                              = "516",
      label_mode                                      = "fixed",
      cmac                                            = "1",
)
if _result_['status'] != IxiaHlt.SUCCESS:
