...
#   - Configure VA behing EVPN VxLAN Device Group.                             #
...
_result_ = ixiangpf.network_group_config (
    protocol_handle                 =  networkGroup_4_handle,
...
ipv4PrefixPools_40_handle = _result_['ipv4_prefix_pools_handle']
networkGroup_60_handle =  _result_['network_group_handle']
...
if _result_['status'] != IxiaHlt.SUCCESS:
    ErrorHandler('emualtion_bgp_route_config', _result_)
...
_result_ = ixiangpf.network_group_config (
    protocol_handle                 =    networkGroup_9_handle,
...
ipv4PrefixPools_70_handle = _result_['ipv4_prefix_pools_handle']
networkGroup_80_handle = _result_['network_group_handle']
...
if disable_ipPrefix['status'] != IxiaHlt.SUCCESS:
    ErrorHandler('emulation_bgp_route_config', disable_ipPrefix)
...
print "On The Fly enable IPv4 Prefix Range"
#(handle : user needs to create and provide handle for cMacProperties, as scriptgen does not return this handle by default)
enable_ipPrefix = ixiangpf.emulation_bgp_route_config (
   handle    = '/topology:1/deviceGroup:1/networkGroup:1/deviceGroup:1/networkGroup:1/networkGroup:1/ipv4PrefixPools:1/evpnIPv4PrefixRange:1',
   mode      = 'enable')

if enable_ipPrefix['status'] != IxiaHlt.SUCCESS:
    ErrorHandler('emulation_bgp_route_config', enable_ipPrefix)
