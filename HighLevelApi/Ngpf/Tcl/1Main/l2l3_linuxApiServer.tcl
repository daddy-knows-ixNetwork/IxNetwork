...
set ixiaChassisIp 192.168.70.128
set ixNetworkTclServerIp 192.168.70.12
set licenseServerIp [list 192.168.70.3]
...
set connectStatus [ConnectToIxiaNgpf "-reset -device $ixiaChassisIp -port_list $portList -ixnetwork_tcl_server $ixNetworkTclServerIp -ixnetwork_license_servers $licenseServerIp -ixnetwork_license_type $licenseMode -user_name admin -user_password admin -close_server_on_disconnect 1 -break_locks 1"]

#set connectStatus [ConnectToIxiaNgpf "-ixnetwork_tcl_server $ixNetworkTclServerIp -session_resume_keys 0 -user_name admin -user_password admin -sessi#on_id 7 -close_server_on_disconnect 0"]
