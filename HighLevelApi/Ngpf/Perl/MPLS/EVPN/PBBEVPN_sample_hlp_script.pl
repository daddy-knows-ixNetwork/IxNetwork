...
#                                                                              #
# Description:                                                                 #
#    This script intends to demonstrate how to use NGPF PBB EVPN HLP API.      #
#                                                                              #
...
my $bgp_ipv4_evpn_pbb_1_status = ixiangpf::emulation_bgp_route_config ({
...
my $bgpIPv4EvpnPbb_1_handle = ixiangpf::status_item('evpn_evi');
...
my $bgpIPv4EvpnPbb_2_status_modify = ixiangpf::emulation_bgp_route_config ({
    handle                                           => "$bgpIpv4Peer_1_handle",
    mode                                             => "modify",
    active                                           => "1",
    num_broadcast_domain                             => "1",
    b_mac_first_label                                => "116",
    enable_b_mac_second_label                        => "1",
    b_mac_second_label                               => "216",
    pbb_evpn                                         => "1",
    no_of_mac_pools                                  => "1",
...
# Add EVI(PBB) stack on top of BGP
print "Add EVI(PBB) stack on top of BGP\n";
my $bgp_ipv4_evpn_pbb_3_status = ixiangpf::emulation_bgp_route_config ({
...
my $bgpIPv4EvpnPbb_3_handle = ixiangpf::status_item('evpn_evi');
...
# Configure EVI parameters
print "Configure EVI parameters\n";
my $bgpIPv4EvpnPbb_4_status_modify = ixiangpf::emulation_bgp_route_config ({
    handle                          => "$bgpIpv4Peer_2_handle",
    mode                            => "modify",
    active                          => "1",
    pbb_evpn                        => "1",
    no_of_mac_pools                 => "1",
    enable_broadcast_domain         => "1",
    b_mac_first_label               => "316",
    enable_b_mac_second_label       => "1",
    b_mac_second_label              => "416",
});
$HashRef = ixiangpf::get_result_hash();
$command_status = $HashRef->{'status'};
if ($command_status != $ixiangpf::SUCCESS) {
