...
print "Creating PIMv4 Stack on top of IPv4 1 stack\n";
my $pim_v4_interface_1_status = ixiangpf::emulation_pim_config ({
    mode                           => "create",
...
my $pimV4Interface_1_handle = $HashRef->{'pim_v4_interface_handle'};

#Creating Multicast Group address

print "Creating Multicast Group address\n";
my $pim_v4_join_prune_list_2_status = ixiangpf::emulation_multicast_group_config ({
    mode               => "create",
...
my $network_group_1_status = ixiangpf::network_group_config ({
    ...
    type                                 => "ipv4-prefix",
    ipv4_prefix_network_address          => "$multivalue_2_handle",
...
my $pimV4SourcesList_5_handle = $HashRef->{'pim_v4_source_handle'};

#Creating Group Address for Candidate RP

print "Creating Group Address for Candidate RP\n";
my $pim_v4_candidate_r_ps_list_3_status = ixiangpf::emulation_multicast_group_config ({
    mode               => "create",
    ip_addr_start      => "225.0.0.0",
    num_groups         => "1",
    active             => "1",
