...
my $device_group_2_status = ixiangpf::topology_config ({
    ...
    device_group_name       => "{SYSTEM1-StaticLag-RHS}",
    device_group_multiplier => "1",
    device_group_enabled    => "1",
});
$HashRef = ixiangpf::get_result_hash();
...
print "\nCreating Static LAG on top of Ethernet Stack for the first Device Group with LAG id 666\n";
    ...
    @status_keys = ixiangpf::status_item_keys();
    my $sys1_lhs_lagId_multivalue_handle = ixiangpf::status_item('multivalue_handle');

    my $static_lag_1_status = ixiangpf::emulation_lacp_link_config ({
        mode              => "create",
    ...
    @status_keys = ixiangpf::status_item_keys();
    my $staticLag_1_handle = ixiangpf::status_item('staticLag_handle');
...
print "\nCreating Static LAG on top of Ethernet Stack for the second Device Group with LAG id 777\n";
    ...
    @status_keys = ixiangpf::status_item_keys();
    my $sys1_rhs_lagId_multivalue_handle = ixiangpf::status_item('multivalue_handle');

    my $static_lag_2_status = ixiangpf::emulation_lacp_link_config ({
        mode              => "create",
    ...
    @status_keys = ixiangpf::status_item_keys();
    my $staticLag_2_handle = ixiangpf::status_item('staticLag_handle');
...
################################################################################
print "\nFetching SYSTEM1-StaticLag-LHS learned_info\n\n";
